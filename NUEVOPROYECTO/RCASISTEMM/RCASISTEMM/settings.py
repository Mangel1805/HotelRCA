"""
Django settings for RCASISTEMM project.
...
SECRET_KEY = '-2n1(*0qqkm1c-+&*=0a%j)87390#e7otgz1$8i$6$51r$aged'
...
ROOT_URLCONF = 'RCASISTEMM.urls'

WSGI_APPLICATION = 'RCASISTEMM.wsgi.application'
