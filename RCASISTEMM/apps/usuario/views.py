...
def generar_pdf(request):
    ...
    titulos = ('Id','Nombre','Teléfono','Email','Dirección','Cargo')
    consulta = [(aux.id,aux.usuario,aux.telefono,aux.correo,aux.direccion,aux.cargo) for aux in Perfiles.objects.all()]
    print consulta
